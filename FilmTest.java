...
{
    private Film killBill;
    private Categorie action;
    ...
    public void testSetDuree()
    {
        ...
        assertEquals(111, killBill.getDuree());
    }

    @Test
    public void testSetDateSortie()
    {
        killBill.setDateSortie("2003/10/29");
        assertEquals("2003/10/29", killBill.getDateSortie());
    }
